    ...
    {/* Left Panel: Chat List */}
      ...
      {showChat && (
        <div className="flex-1 flex flex-col glass-card overflow-hidden h-[60%] min-[600px]:h-full min-[600px]:min-w-[340px] min-[900px]:min-w-[360px] min-w-0">
            ...
            <div className="flex items-center gap-3">
              {!isLoading && isSmallScreen && activePane === 'chat' && (
                <motion.button 
                  ...
                  className="text-white/40 hover:text-white transition-colors p-1.5 rounded-lg"
                >
                  <ChevronLeft size={18} />
                </motion.button>
              )}
          ...
          {/* Message Area */}
          <div className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar bg-obsidian/20 min-w-0">
            {isLoading ? (
