...
import { Search, Bell, Mail, ChevronDown, Zap, Menu, Moon, Sun } from 'lucide-react';
      ...
      <div className="flex items-center h-full gap-3">
        ...
        <div className="flex items-center gap-3 cursor-pointer group pt-1 ml-auto">
          <div className="text-right">
            ...
            <p className="text-[9px] text-muted-theme font-medium">Admin Account</p>
          </div>
          ...
          <ChevronDown size={12} className="text-muted-theme group-hover:text-theme transition-colors" />
        </div>
      </div>
    </header>
  );
